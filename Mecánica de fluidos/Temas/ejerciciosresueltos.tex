...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item La aceleración de la partícula fluida cuando en t=0s pasa por el punto (0,1,0)
			\[\textcolor{red}{a_L=\frac{\partial\vec{v}}{\partial t}=-ye^{-t}\vec{k}}\]
		\[\textcolor{red}{a_c=\left(\vec{v}\cdot\vec{\nabla}\right)\vec{v}=
		...
		\[\textcolor{red}{a_c=\left(v_y\frac{\partial v_y}{\partial y} + v_z\frac{\partial v_y}{\partial z} \right)
	...
	\]
		...
		\item ¿Podría tratarse de un líquido?
			\[\textcolor{red}{traza(\overline{\overline{\xi}})=1-1=0\rightarrow \text{Es un líquido.} }\]
	...
	\begin{enumerate}
		...
		\item La aceleración de la partícula fluida: total, local, convectiva y las contribuciones de la aceleración convectiva
			...
			\[\textcolor{red}{a_L=\frac{\partial\vec{v}}{\partial t}=z(1+4t)\vec{j}}\]
			\[\textcolor{red}{a_c=\left(\vec{v}\cdot\vec{\nabla}\right)\vec{v}=
			\left(v_x\frac{\partial}{\partial x}
			+
		v_y\frac{\partial}{\partial y}
		...
		v_y\frac{\partial}{\partial z}
			...
			\[\textcolor{red}{a_{c_d}=-\vec{v} \times \left(\vec{\nabla}\times\vec{v}\right)=(\vec{v} \cdot\vec{\nabla})\vec{v}-\vec{\nabla}\frac{|\vec{v}|}{2}^2
			}\]
			\[\textcolor{red}{a_{c_v}=\left[z(1+4t)+2y(t+2t^2)-4y\right]\vec{j}+z(2t+3t^2-4t^3-4t^4)\vec{k}}\]
	...
	\[\textcolor{red}{\overline{\overline{\gamma}}=\begin{bmatrix}
		...
		\[\textcolor{red}{traza(\overline{\overline{\xi}})=0\rightarrow \text{Es un líquido.} }\]
	\end{enumerate}
...
\begin{enumerate}
	...
	\begin{figure}[H] \begin{minipage}{0.7\textwidth}
		\centering
	...
	másico $\dot{m }$ = $C_p$, donde $\rho$ es la densidad del aire del depósito y C es una constante. Se
	...
	diámetro $D_s$. Se pide calcular la velocidad vs en función de los datos del ejercicio.
	\begin{figure}[H] \begin{minipage}{0.7\textwidth}
		\centering
	...
	v = 0; w = 0, y densidad $\rho$ =  $\rho _0$ [a - cos ($\omega$t)] con a$>$1. Determinar la función u (x, t)
	sabiendo que u (0, t) = $u_0$.
\end{enumerate}
\newpage
