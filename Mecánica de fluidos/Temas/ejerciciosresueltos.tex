...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{imagenesEjercicios/fuerzaDepositoNagujeros}
...
\blue
 ...
 Como el volumen de control no varia (se pretende obtener el valor de la fuerza con el cual h no varía) y teniendo en cuenta desarrollos de ejercicios anteriores:
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{imagenesEjercicios/arrastreFluido}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{imagenesEjercicios/flujoViscosidadDominante1}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{imagenesEjercicios/emboloDiametroDescendente}
		\caption{Esquema del problema.}
