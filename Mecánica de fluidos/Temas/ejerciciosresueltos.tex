...
\black
\newpage
\item Calcular la altura, h, si la fuerza del fluido sobre el depósito es nula.

\item Hallar la expresión de la presión a aplicar sobre la masa en función de las magnitudes del problema.
\item Hallar el volumen en función del tiempo en el siguiente depósito. El deposito tiene un gas en la parte superior y un líquido en la inferior.
...
\begin{enumerate}
	\item Hallar la velocidad mínima para arrastrar toda la película líquida hacia arriba.
	\item Hallar la dinámica del vaciado si el flujo es de viscosidad dominante.
