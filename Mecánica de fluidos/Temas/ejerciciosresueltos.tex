...
\section{Fluidoestática.}
	\begin{enumerate}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\linewidth]{imagenesEjercicios/compuerta1}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\linewidth]{imagenesEjercicios/compuerta2}
		\end{figure}
