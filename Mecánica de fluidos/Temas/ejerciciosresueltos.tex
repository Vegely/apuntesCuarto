...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{imagenesEjercicios/masaMovilRadio}
	\caption{Esquema del problema.}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imagenesEjercicios/arrastreFluido}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imagenesEjercicios/flujoViscosidadDominante1}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{imagenesEjercicios/emboloDiametroDescendente}
		\caption{Esquema del problema.}
