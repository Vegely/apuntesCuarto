...
\subsection{Fuentes de energía no renovable.}
	...
	\subsection{Fuentes de energía renovable.}
		...
		\subsection{Concepto de energía primaria, final y útil.}
			\begin{itemize}
		...
		\subsection{Consumo mundial de energía primaria.}
		...
		\subsection{Contribución de las energías renovables a la reducción del consumo de energías primarias.}
			...
			\subsubsection{Plan de fomento de las energías renovables en España (PANER, 2011-2020)}
			...
			\subsubsection{Plan nacional integrado de energía y clima (PNIEC, 2011-2030)}
		...
		\subsection{Evolución de la potencia renovable instalada en régimen regulado en España.}
			\begin{table}[htbp]
				\centering
		...
		\subsection{Potencia instalada y evolución de la demanda en España.}
			\begin{table}[htbp]
		...
		\subsection{Balance de producción de energía eléctrica en España.}
			Datos en \textit{GWh}.
			\begin{table}[htbp]
				\renewcommand{\arraystretch}{1.2}
				\centering
		...
		\subsection{Balance de intercambios internacionales.}
			...
			\begin{tikzpicture}
				\begin{axis}[
					...
					restrict y to domain=-10:10, % Filtrar valores de y
					]
					...
					\addplot[orange,sharp plot,update limits=false] coordinates {
						(2019,220000)
						(2020,225000)
						(2021,227000)
						(2022,228000)
					...
					\legend{Pérdidas de transporte, Demanda}
				\end{axis}
			\end{tikzpicture}
			...
			\begin{figure}
				...
				\begin{tikzpicture}
					\begin{groupplot}[
						...
						\addlegendentry{Bar Plot}
						
						% Line Plot on the right y-axis
						\nextgroupplot[
						red,
						mark=*,
						smooth,
						...
						\addlegendentry{Line Plot}
						
					\end{groupplot}
				\end{tikzpicture}
				\caption{Double Axis Plot.}
				\label{fig:double_axis_plot}
			\end{figure}
